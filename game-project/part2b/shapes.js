...
function drawCloud(x, y, width, height) {
  // make a const with 30% of the total width
...
// use multiple triangles to make mountain layers, use gray and brown to differentiate
function drawMountain(x, y, width, height) {
  // use beginShape, vertex and endShape. Create a mountain that looks like a triangle, but has the top white like snow.
  // use gray and brown to differentiate. white for snow
  fill(140, 140, 140);
