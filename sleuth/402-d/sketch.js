...
Officer: 6319957
CaseNum: 402-3-86263611-6319957
...
function draw() {
  ...
  if (det.locationY > 509) {
    det.speedY = -1;
    det.speedX = 0;
  } else if (det.locationX > 190 && det.locationY > 380) {
    det.speedX = -1;
    det.speedY = 0;
  } else if (det.locationY > 380) {
    det.speedY = -1;
    det.speedX = 0;
  } else if (det.locationX < 570 && det.locationY > 260) {
    det.speedX = 1;
    det.speedY = 0;
  } else if (det.locationY > 260) {
    det.speedY = -1;
    det.speedX = 0;
  } else if (det.locationX > 320 && det.locationY > 130) {
    det.speedX = -1;
    det.speedY = 0;
  } else if (det.locationY > 130) {
    det.speedY = -1;
    det.speedX = 0;
  } else if (det.locationX < 820 && det.locationY > 70) {
    det.speedX = 1;
    det.speedY = 0;
  } else if (det.locationY > 70) {
    det.speedY = -1;
    det.speedX = 0;
  } else if (det.locationX > 130 && det.locationY > 0) {
    det.speedX = -1;
    det.speedY = 0;
  } else {
    det.speedY = -1;
